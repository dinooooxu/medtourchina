...
function Contact() {
  ...
  const countries = [
    ...
    'India', 'UAE', 'Saudi Arabia', 'Russia', 'Brazil', 'Mexico',
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows="6"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                  placeholder="Please describe your medical needs or questions..."
                ></textarea>
              </div>

              <div className="mb-6">
                <p className="text-xs text-gray-500">
                  * Your personal information will be kept confidential and used only to respond to your inquiry.
                </p>
              </div>
          ...
          <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-primary-100 p-3 rounded-lg">
                    <svg className="w-6 h-6 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold mb-1 text-gray-800">Email</h3>
                    <p className="text-gray-600">info@medtourchina.com</p>
                    <p className="text-gray-600">support@medtourchina.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 text-gray-800">Business Hours</h3>
            ...
            <div className="bg-primary-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                We typically respond to all inquiries within 24 hours. For urgent matters, please call our 24/7 hotline.
              </p>
              ...
              <div className="flex items-center gap-2 text-primary-600 mt-2">
                ...
                <span className="font-semibold">Professional & Confidential</span>
              </div>
            </div>
          </div>
        </div>
